    ...
    return (
        <div className="service component__space" id="Service">
            <div className="heading">
                ...
                <p className="heading p__color">There are manuy Variation of Lorem Ipsum Avialable,</p>
                <p className="heading p__color">but majority have suffered alteration.</p>
            </div>
                    ...
                    <div className="col__3">
                        ...
                        <div className="service__meta">
                            ...
                            <p className="service__text p__color">
                                I throw myself down among the time
                            </p>
                            <p className="service__text p__color">
                                I throw myself down among the time
                            </p>
